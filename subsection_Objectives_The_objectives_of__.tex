...
\item Deploy a subset of features on a data set of over 10,000 buildings to test the ability to predict whether an energy-savings measure implementation will be a success 
\end{enumerate}