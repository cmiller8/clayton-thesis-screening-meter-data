...
\newcommand{\degree}{DOCTOR OF SCIENCES of ETH Z\"URICH}
\newcommand{\shortdegree}{(Dr. sc. ETH Z\"urich)}
...
\mainmatter3
\include{ch1_Introduction}                              % include 
\include{ch2_LitReview}
\include{ch3_Methodology}
\include{ch4_Stats}
\include{ch5_Modelbased}
\include{ch6_Patternbased}
\include{ch7_Results}
\include{ch8_AMIData}
\include{ch9_Conclusions}

\appendix
\include{App_temporalfeatures}
